...
MESSAGE("LUABIND_INCLUDE_DIR = " ${LUABIND_INCLUDE_DIR})
MESSAGE("LUABIND_DEBUG_LIBRARY = " ${LUABIND_DEBUG_LIBRARY})
MESSAGE("LUABIND_RELEASE_LIBRARY = " ${LUABIND_RELEASE_LIBRARY})
...
ELSE()
  SET(LUABIND_LIBRARIES ${LUABIND_RELEASE_LIBRARY} CACHE STRING "LuaBind Libraries")
ENDIF()
